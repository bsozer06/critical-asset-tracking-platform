...
import { GeofenceAlertComponent } from '../geofence-alert/geofence-alert.component';
...
export class DashboardComponent implements OnInit {
  ...
  onViolationDetected(violation: GeofenceViolation) {
    ...
    setTimeout(() => {
      ...
      if (index > -1) this.activeViolations.splice(index, 1);
    }, 15000);
  }
  ...
  showSnackbar(message: string) {
    ...
    this.snackbarTimeout = setTimeout(() => { this.snackbarVisible = false; }, 4000);
  }
}
